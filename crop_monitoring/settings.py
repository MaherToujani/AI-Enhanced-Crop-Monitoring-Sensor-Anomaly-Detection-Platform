...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-6rzs)=v7c$$rg#f=i_#m(jfufjypjy@7dwthn449l(zc)ryvfh')
...
if not all([DB_NAME, DB_USER, DB_PASSWORD]):
    raise ImproperlyConfigured(
        "PostgreSQL environment variables (DB_NAME, DB_USER, DB_PASSWORD) are required."
    )
